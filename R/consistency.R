...
#' @param threshold a numeric value for the minimum active years to consider - for example, if someone is a first time donor they will have 100 percent consistency to only include those that could have given at least 3 fiscal years, change threshold to 3
