...
#' @param ids an unquoted column name that contains the constituent IDs
#' @param fys an unquote column name that contains the fiscal year for gifts. If not present, run fy() or fy2().
